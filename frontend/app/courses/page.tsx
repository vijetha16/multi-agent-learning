...
export default function Courses(){
 ...
 useEffect(()=>{load()},[]);
 async function enroll(course:Course){try{await api(`/courses/${course.id}/enroll`,{method:"POST"});router.push("/dashboard")}catch(e){setError(e instanceof Error?e.message:"Unable to enroll")}}
